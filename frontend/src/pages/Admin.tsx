...
export function Admin() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0908] text-[#f4f1de] select-none flex fonte-corpo">
      ...
      {/* 🏛️ 1. BARRA LATERAL ISOLADA */}
      <Sidebar />

      {/* CONTAINER DA DIREITA: Empilha Header + Conteúdo */}
      <div className="flex-1 flex flex-col min-w-0">
        
        {/* 👑 NOVO HEADER NO ADMIN */}
        <Header />

        {/* 🏛️ 2. PAINEL DE CONTEÚDO PRINCIPAL */}
        <main className="p-6 md:p-12 space-y-12 max-w-7xl mx-auto w-full overflow-hidden">
          ...
          {/* 🏛️ ENVELOPE DA TABELA INTEGRADA */}
